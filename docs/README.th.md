...
**กราฟเส้นโควตาแพลน** (เปอร์เซ็นต์ 5H / 7D / รายโมเดล วาดเป็นเส้นโค้ง
หลากสีบนแกนเวลา 24 ชั่วโมงเดียวกัน — เก็บตัวอย่างโควตาทุก ~1 นาที
กราฟจึงเริ่มแสดงหลังใช้งานไม่กี่นาที),
...
legend ชื่อโมเดล และยอดรวม 7 วันด้านล่าง refresh ทุก ~2 วินาที

บนการ์ดยังมี **สัตว์เลี้ยงจาก [tamaclaude](https://github.com/thaitop/tamaclaude)** —
มาสคอตส้มตัวจิ๋วที่ขยับตามสิ่งที่ Claude Code กำลังทำแบบเรียลไทม์:
ส่องแว่นขยายตอนอ่านไฟล์, พิมพ์แล็ปท็อปตอนแก้โค้ด, ทุบค้อนตอนรัน Bash,
หมุนลูกโลกตอนค้นเว็บ, ฉลองเมื่องานเสร็จ, ถือนาฬิการอคำตอบ
และหลับเมื่อไม่มีการใช้งาน — ติดตั้ง hook ด้วย
