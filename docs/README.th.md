...
|---|---|---|
| Block 5 ชั่วโมง | `5H ████░░░░ 45% $48.64 ⏳1h40` | แถบและ % เทียบกับ block ที่ใหญ่ที่สุดที่เคยใช้ (ตัวแทนโควตาแบบปรับตัวเอง), ค่าใช้จ่าย, เวลาก่อน reset |
| หน้าต่าง 7 วัน | `7D $365 · 664.1M` | ค่าใช้จ่ายและ token รวมย้อนหลัง 7 วัน |
